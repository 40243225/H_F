...
class Get_FB_Data
{
  ...
  protected $loginUrl;
   function __construct($id) {
       ...
       $this->loginUrl = $helper->getLoginUrl('http://cloudsoftwarelab404.info/h_f/action/FB_action/fb-callback.php?id='.$id, $permissions);
       echo '<a href="'.htmlspecialchars($this->loginUrl).'"><img src="./image/fblogin.png" border="0"></a>';
       //echo $loginUrl;
